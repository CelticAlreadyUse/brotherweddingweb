...
const Opening = () => {
  ...
  return (
    ...
    <div className='h-svh z-10 relative bg-opening grid place-content-center place-items-center'>
        ...
        <Link to={'/home'} data-aos="fade-up" className='flex gap-5 mt-5 bg-slate-500 px-5 py-2 rounded-md items-center'><strong className='text-white text-4xl'>Open the Invitation</strong><FaEnvelopeOpenText className='text-white' size={32} /> </Link> 
    </div>
    </>
  )
}
